...
Like in the Explore and Suggest tabs, we will use Kennedy - Goldsborough as our selected area considering all HUC 12s. This time, however, we are going to only consider County owned culverts with no Already Planned / Will Complete. 
...
We now generate a map when we click submit that highlights our planned culverts in blue showing their location and the habitat that they open up. If a culvert has downstream barriers the habitat above will not be considered and will appear red as blocked. 
...
We also now have a report with the culverts estimated costs along with the total habitat gain and habitat per species. 
...
::: columns
::: {.column width="55%"}
The Learn feature contains links to this manual as well as additional about the app. 
...
Some culverts are well beyond a distance that allows them to be linked to any NHD line. We are in the process of considering how lidar burn-in lines might help address if these culverts are on unidentified or incorrectly assigned NHD lines. More details to come. 
