...
4.  For style, use "Cost" as the fill color. [*let's give the example of color by the \# of downstream barriers*]{style="color:blue"}
...
scatter plot. [*the figure shown here should have the highlights*]{style="color:blue"}
:::
...
defined in the WDFW inventory. This includes City, County, Federal,
Private, State, Tribal, Other, Port, Drainage District, Irrigation
District, and Unknown. [*it would be nice to have the same system in the Explore and Suggest demos. I want to use the same one at the launch meeting, so let's spend some time picking one out.*]{style="color:blue"}
:::
...
Complete field. Once added, click the submit button again. [*why submit again?*]{style="color:blue"}
...
::: columns
::: {.column width="55%"}
Users must provide a budget in US dollars---such as 80000 in the example to the right.

For example, on the right we allow for Upstream to a suggest
culvert restoration plan of all ownership types in all sub-areas within the Chambers-Clover WRIA. No further customization was made.

Note that the suggested solution will not exceed the provided budget. Therefore, it is important to check whether the solution is subtantially changed by adding small amounts to the provided budget.
...
::: columns
::: {.column width="55%"}
Map Results: **left off here, but wondering if we should get rid of this**
